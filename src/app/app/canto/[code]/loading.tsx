...
export default function CantoLoading() {
  return (
    <div className="flex min-h-[65vh] w-full flex-col items-center justify-center gap-5 py-12 animate-in fade-in duration-150">
      ...
      <div className="flex flex-col items-center gap-1.5 text-center">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-semibold tracking-tight">Carregando Canto…</h3>
        </div>
        <p className="text-muted-foreground text-xs">
          Buscando circuitos, lições e progresso do Canto
        </p>
      </div>
