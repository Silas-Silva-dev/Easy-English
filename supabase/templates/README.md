...
Este diretório contém os templates HTML estilizados com a identidade visual do **InglishEasy** (tema escuro elegante, logo em gradiente e botão de alta conversão) para substituição dos e-mails padrão em inglês do Supabase.
...
2. Selecione o seu projeto do **InglishEasy**.
